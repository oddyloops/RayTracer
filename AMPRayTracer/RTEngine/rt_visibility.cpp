...
void rt_visibility::compute_visibility(ray r, int except_geom_index, intersection_record& rec, array_view<rt_sphere, 1>* spheres, array_view<rt_rectangle, 1>* rects,
	array_view<rt_triangle, 1>* triangles, array_view<rt_plane, 1>* planes, array_view<rt_cylinder, 1>* cylinders, texture_view<const float_3, 3> bitmaps, texture_view<const float_3, 1> scalars
