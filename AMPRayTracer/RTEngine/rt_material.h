...
namespace rt_support
{
	namespace scene_resource_support
	{
		...
		public:
			...
			float_3 get_ambient_color(float u, float v, array_view<float_3,3>* bitmaps, array_view<float_3,1>* scalars) restrict(amp);

			float_3 get_diffuse_color(float u, float v, array_view<float_3, 3>* bitmaps, array_view<float_3, 1>* scalars) restrict(amp);
			
			float_3 get_specular_color(float u, float v, array_view<float_3, 3>* bitmaps, array_view<float_3, 1>* scalars) restrict(amp);

			float get_specularity(float u, float v, array_view<float, 3>* bitmaps, array_view<float, 1>* scalars) restrict(amp);

			float get_refractive_index(float u, float v, array_view<float, 3>* bitmaps, array_view<float, 1>* scalars) restrict(amp);

			float get_transparency(float u, float v, array_view<float, 3>* bitmaps, array_view<float, 1>* scalars) restrict(amp);

			float get_reflectivity(float u, float v, array_view<float, 3>* bitmaps, array_view<float, 1>* scalars) restrict(amp);
