...
scene_results rt_gateway::ray_trace(vector<rt_sphere> spheres, vector<rt_rectangle> rectangles, vector<rt_triangle> triangles,
	...
	vector<rt_area_light> a_lights, vector<float> ambience_color, float ambience_intensity, rt_camera camera,image_spec spec)
{
	...
	scene_database db = scene_database(spheres, rectangles,triangles,materials,a_lights,s_lights,d_lights,p_lights);
